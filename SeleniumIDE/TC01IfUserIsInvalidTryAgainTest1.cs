...
public class TC01IfUserIsInvalidTryAgainTest
{
    ...
    public void SetUp()
    {
        ...
        string usingDataDir = Path.Combine(Path.GetTempPath(), Path.GetRandomFileName());

        Directory.CreateDirectory(usingDataDir);

        options.AddArgument($"--user-data-dir={usingDataDir}");
